	...
	<form class="login-form" action="{{ route('login') }}" method="post">
		...
		<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="email" autocomplete="off" value="{{ old('email') }}" placeholder="Email" name="email"/>
                @if ($errors->has('email'))
	...
	<form class="register-form" action="{{ route('register') }}" method="post">
		...
		<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" placeholder="Full Name" value="{{ old('name') }}" name="name"/>
                @if ($errors->has('name'))
                    <span class="help-block">
